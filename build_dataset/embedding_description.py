...
if __name__ == '__main__':
    ...
    relation_embedding(model_name = 'chemdfm', pooling = 'mean')
    disease_embedding(model_name = 'chemdfm', pooling = 'mean')
    chemical_embedding(model_name = 'chemdfm', pooling = 'mean')
    phenotype_embedding(model_name = 'chemdfm', pooling = 'mean')
    pathway_embedding(model_name = 'chemdfm', pooling = 'mean')
    go_embedding(model_name = 'chemdfm', pooling = 'mean')
    gene_embedding(model_name = 'chemdfm', pooling = 'mean')

    cd_embedding_data(model_name = 'chemdfm', pooling = 'mean')
    cgd_embedding_data(model_name = 'chemdfm', pooling = 'mean')
    cgpd_embedding_data(model_name = 'chemdfm', pooling = 'mean')
    ctd_embedding_data(model_name = 'chemdfm', pooling = 'mean')
